...
const services = [
  ...
  },
  {
    ...
    desc: "CNA, LVN, HHA, PCA and companion caregivers — carefully matched to your care home's culture, residents, and documentation requirements.",
    img: care1,
  },
  {
    icon: Briefcase,
    tag: "Staffing + Leadership",
    title: "Fractional Managers",
    desc: "Short-term administrators, Directors of Nursing (DONs), and operational managers — staffing and leadership support to keep your facility survey-ready.",
    img: care3,
  },
  {
    icon: Brain,
          ...
          {services.map(({ icon: Icon, tag, title, desc, img }) => (
            ...
            >
              ...
              <div className="flex flex-1 flex-col p-5">
                <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-xl bg-primary text-white shadow-lg">
